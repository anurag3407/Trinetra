...
import { ArrowRight, Radio, Smartphone, Menu, X, Info, GitBranch, Layers } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 bg-[#F0F0F0] border-b-4 border-[#121212]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <Link
            href="/field"
            className="flex items-center gap-1.5 px-4 py-2.5 bg-white text-[#121212] border-2 border-[#121212] shadow-[3px_3px_0px_0px_#121212] font-bold text-xs uppercase tracking-wider hover:bg-gray-100 transition-all active:translate-x-[1px] active:translate-y-[1px] active:shadow-none"
          >
        ...
        <div className="flex md:hidden items-center gap-2">
          <Link
            href="/dashboard"
            className="px-3 py-1.5 bg-[#D02020] text-white border-2 border-[#121212] font-black text-[11px] uppercase tracking-wider"
          >
            Canvas
          </Link>
          <button
